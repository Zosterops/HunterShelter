...
static void *app_function (void *userdata) {
  ...
  /* Build pipeline */
  data->pipeline = gst_parse_launch("udpsrc port=5004 caps=\"application/x-rtp, media=video, clock-rate=90000, encoding-name=H264\" ! rtph264depay ! avdec_h264 ! autovideosink sync=false", &error);
...
jint JNI_OnLoad(JavaVM *vm, void *reserved) {
  ...
  jclass klass = (*env)->FindClass (env, "com/zosterops/huntershelter/MainActivity");
